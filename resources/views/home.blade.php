    ...
    <div class="section-container">
        ...
        <div class="featured-header">
            ...
            <div>
                ...
                <h2>
                    Verified responders currently<br>
                    active across Dhaka.
                </h2>
        ...
        <div class="provider-grid">
            ...
            <div class="provider-card">
                ...
                <img src="{{ asset('images/ambulanceprovider1.jpg') }}" alt="Rapid Care Ambulance">
            ...
            <div class="provider-card">
                ...
                <img src="{{ asset('images/ambulanceprovider2.jpg') }}" alt="City Rescue Ambulance">
            ...
            <div class="provider-card">
               ...
               <img src="{{ asset('images/blooddoner.jpg') }}" alt="Lifeline Blood Network">
            ...
            <div class="provider-card">
                ...
                <img src="{{ asset('images/nurse.jpg') }}" alt="Nurse Farhana Akter">
